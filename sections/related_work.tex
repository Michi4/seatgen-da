...
In practice, large or complex venues may have thousands of individual seat entities, which could impact performance if data management is not optimized. Additionally, the zoom levels require memory- and compute-efficient image slicing and compression to avoid excessive storage usage on AWS. The design choices reflect these constraints and requirements in multiple areas.
