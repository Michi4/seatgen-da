did we cover everything with this in the mapcomponent now?
i left out the whole category thing because its for the detail editor later
please also remove the grouping stuff thats for the detail editor
also fix the saving stuff because we dont save automatically we are only telling the user that he has unsaved changes when he wants to leave (unload)
this is the current state of it with what i checked and setteled for now:
