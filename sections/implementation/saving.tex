SeatGen uses a save button to save the currently edited state and changes in the map. This has some advantages and disadvantages, when saving every time an action occurs. Some advantages are:
