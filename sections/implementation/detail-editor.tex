...
The Listing \autoref{lst:create-seat-group} demonstrates how a new group is created from currently selected seats:
...
To remove a previously created seat group, the logic shown in Listing \autoref{lst:delete-seat-group} is used:
