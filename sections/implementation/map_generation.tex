...
While Zopfli is significantly slower than standard Deflate or zlib, this isn't a huge problem for this use case, because time can be sacrificed once for the optimization and speed improvement for the user.
